...
namespace SCA.Infrastructure.Migrations
{
    ...
    [Migration("20240913123118_InitialCreate")]
            ...
            modelBuilder.Entity("SCA.Domain.Entities.Connector", b =>
                {
                    ...
                    b.OwnsOne("SCA.Domain.ValueObjects.MaxCurrentAmps", "MaxCurrent", b1 =>
                        {
            ...
            modelBuilder.Entity("SCA.Domain.Entities.Group", b =>
                {
                    ...
                    b.OwnsOne("SCA.Domain.ValueObjects.CapacityAmps", "Capacity", b1 =>
                        {
                            b1.Property<Guid>("GroupId")
                                .HasColumnType("TEXT");
